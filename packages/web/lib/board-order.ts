...
import { parseScreen, type Board, type BoardScreen, type BoardsManifest, type Project } from "@screendeck/core";
import { loadBoardsFromFs, saveBoardsToFs } from "@screendeck/core/fs";
